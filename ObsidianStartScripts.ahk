...
; m(retVal)
menu, tray, tip, % txt
Programs:={ Discord : "C:\Users\Author1\AppData\Local\Discord\Update.exe  --processStart Discord.exe"
			,Spot: "Spotify.exe"
...
ttip(Embed "|"  Path )
run,% Path 
; run, % "C:\@C:\Users\Author1\AppData\Local\Discord\Update.exe  --processStart Discord.exeart Discord.exe
